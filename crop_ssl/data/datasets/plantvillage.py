...
class PlantVillageDataset(Dataset):
    ...
    def _create_synthetic_dataset(self):
        ...
        import zlib
        import numpy as np
        # Per-dataset seed: fallback content must not depend on which other
        # fallbacks ran earlier in the same process (global RNG state), and
        # two datasets must never emit identical bytes.
